...
# 2. BG_NBD Modeli ile Expected Number of Transaction
...
df_ = pd.read_excel("Online Retail CRM Analytics/datasets/online_retail_II.xlsx",
...
# recency : Son satın alma üzerinden geçen zaman. Haftalık. (kullanıcı özelinden)
...
cltv_df = df.groupby('Customer ID').agg({"InvoiceDate" : [lambda date: (date.max() - date.min()).days,
                                         ...
                                         "TotalPrice" : lambda ToralPrice: ToralPrice.sum()})
